package com.ekiosquemanager.core.constants;
...
public class SchemaConstant {
	...
	public final static String EKIOSQUEMANAGER_SCHEMA = "EKIOSQUEMANAGERSTORE";

	/**
	 * Languages iso codes
	 * 
	 */
	public static final String[] LANGUAGE_ISO_CODE = {"en", "fr", "it"};
	
	/**
	 * Languages iso codes with name
	 */
	public static final HashMap<String, String> LANGUAGE_ISO_CODE_MAP = new HashMap<String, String>();
	
	static {
		LANGUAGE_ISO_CODE_MAP.put("en", "English");
		LANGUAGE_ISO_CODE_MAP.put("fr", "Français");
		LANGUAGE_ISO_CODE_MAP.put("it", "Italiano");
	}

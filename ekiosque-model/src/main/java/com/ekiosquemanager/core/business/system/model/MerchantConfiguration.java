...
@Table(name = "MERCHANT_CONFIGURATION", schema= SchemaConstant.EKIOSQUEMANAGER_SCHEMA, uniqueConstraints=
	@UniqueConstraint(columnNames = {"MERCHANT_ID", "CONFIG_KEY"}))
public class MerchantConfiguration extends EkiosqueManagerEntity<Long, MerchantConfiguration> implements Serializable, Auditable {

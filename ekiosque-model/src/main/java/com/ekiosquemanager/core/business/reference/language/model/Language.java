package com.ekiosquemanager.core.business.reference.language.model;
...
@Table(name = "LANGUAGE", schema=SchemaConstant.EKIOSQUEMANAGER_SCHEMA)
@Cacheable
public class Language extends EkiosqueManagerEntity<Integer, Language> implements Auditable {

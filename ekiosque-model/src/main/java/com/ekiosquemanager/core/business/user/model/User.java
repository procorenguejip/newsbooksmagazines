...
@Table(name = "USER", schema=SchemaConstant.EKIOSQUEMANAGER_SCHEMA)
public class User extends EkiosqueManagerEntity<Long, User> implements Auditable {
	...
	@JoinTable(name = "USER_GROUP", schema=SchemaConstant.EKIOSQUEMANAGER_SCHEMA, joinColumns = { 

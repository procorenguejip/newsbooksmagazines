package com.ekiosquemanager.core.business.reference.currency.model;
...
@Entity
@Table(name = "CURRENCY", schema = SchemaConstant.EKIOSQUEMANAGER_SCHEMA)
@Cacheable
public class Currency extends EkiosqueManagerEntity<Long, Currency> implements Serializable {

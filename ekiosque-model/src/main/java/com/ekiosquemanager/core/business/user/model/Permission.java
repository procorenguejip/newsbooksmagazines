...
@Table(name = "PERMISSION", schema=SchemaConstant.EKIOSQUEMANAGER_SCHEMA)
public class Permission extends EkiosqueManagerEntity<Integer, Permission> implements Auditable {
	...
	@JoinTable(name = "PERMISSION_GROUP", schema=SchemaConstant.EKIOSQUEMANAGER_SCHEMA, joinColumns = { 

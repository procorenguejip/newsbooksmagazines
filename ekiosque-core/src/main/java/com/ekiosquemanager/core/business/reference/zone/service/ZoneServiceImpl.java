...
import com.ekiosquemanager.core.business.reference.zone.dao.ZoneDao;
...
import com.ekiosquemanager.core.business.reference.zone.model.Zone_;
import com.ekiosquemanager.core.constants.Constants;
import com.ekiosquemanager.core.utils.CacheUtils;

@Service("zoneService")
public class ZoneServiceImpl extends EkiosqueManagerEntityServiceImpl<Long, Zone> implements
		ZoneService {

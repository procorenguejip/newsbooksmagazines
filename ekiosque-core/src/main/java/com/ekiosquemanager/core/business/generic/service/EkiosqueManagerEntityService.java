 ...
 */
public interface EkiosqueManagerEntityService<K extends Serializable & Comparable<K>, E extends EkiosqueManagerEntity<K, ?>> extends TransactionalAspectAwareService{

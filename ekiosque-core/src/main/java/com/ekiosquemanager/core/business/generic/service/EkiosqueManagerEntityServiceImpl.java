package com.ekiosquemanager.core.business.generic.service;
...
import com.ekiosquemanager.core.business.generic.util.GenericEntityUtils;

/**
 * @param <T> entity type
 */
public abstract class EkiosqueManagerEntityServiceImpl<K extends Serializable & Comparable<K>, E extends EkiosqueManagerEntity<K, ?>>
	implements EkiosqueManagerEntityService<K, E> {
	...
	private EkiosqueManagerEntityDao<K, E> genericDao;

	@SuppressWarnings("unchecked")
	public EkiosqueManagerEntityServiceImpl(EkiosqueManagerEntityDao<K, E> genericDao) {

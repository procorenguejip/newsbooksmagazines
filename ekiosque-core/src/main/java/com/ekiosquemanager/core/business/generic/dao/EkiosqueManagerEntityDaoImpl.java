 ...
 * @param <T> entity type
 */
public abstract class EkiosqueManagerEntityDaoImpl<K extends Serializable & Comparable<K>, E extends EkiosqueManagerEntity<K, ?>>
		extends EkiosqueManagerJpaDaoSupport
		implements EkiosqueManagerEntityDao<K, E> {
	
	private Class<E> objectClass;
	
	@SuppressWarnings("unchecked")
	public EkiosqueManagerEntityDaoImpl() {

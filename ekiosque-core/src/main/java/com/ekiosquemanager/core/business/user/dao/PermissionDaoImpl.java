...
import com.ekiosquemanager.core.business.user.model.QPermission;

@Repository("permissionDao")
public class PermissionDaoImpl extends EkiosqueManagerEntityDaoImpl<Integer, Permission> implements
		PermissionDao {

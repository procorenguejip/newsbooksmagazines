...
import com.ekiosquemanager.core.business.merchant.model.QMerchantStore;


@Repository("merchantStoreDao")
public class MerchantStoreDaoImpl extends EkiosqueManagerEntityDaoImpl<Integer, MerchantStore> implements MerchantStoreDao {

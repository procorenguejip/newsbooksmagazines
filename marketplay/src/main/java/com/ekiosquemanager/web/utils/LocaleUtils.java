...
//import com.ekiosquemanager.web.admin.controller.categories.CategoryController;
...
public class LocaleUtils {
	 ...
	 * This method ignores the language
	 * @param store
	 * @return
	 */
	public static Locale getLocale(MerchantStore store) {
		
		Locale defaultLocale = com.ekiosquemanager.core.constants.Constants.DEFAULT_LOCALE;

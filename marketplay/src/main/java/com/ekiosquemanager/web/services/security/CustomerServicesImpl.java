package com.ekiosquemanager.web.services.security;
...
import com.ekiosquemanager.web.admin.security.SecurityDataAccessException;
...
//				true, true, authorities);
		User authUser = new User(userName, "password", true, true,
				true, true, authorities);

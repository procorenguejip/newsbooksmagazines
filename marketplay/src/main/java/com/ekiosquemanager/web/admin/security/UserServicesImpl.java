package com.ekiosquemanager.web.admin.security;
...
public class UserServicesImpl implements WebUserServices{
	...
	public UserDetails loadUserByUsername(String userName)
		...
		com.ekiosquemanager.core.business.user.model.User user = null;
	...
	public void createDefaultAdmin() throws Exception {
		  ...
		  com.ekiosquemanager.core.business.user.model.User user = new com.ekiosquemanager.core.business.user.model.User("admin",password,"admin@ekiosque.com");

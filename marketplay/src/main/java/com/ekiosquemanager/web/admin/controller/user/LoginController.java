...
public class LoginController {
	...
	@RequestMapping(value="/admin/resetPassword.html", method=RequestMethod.GET)
	public String displayResetPassword(HttpServletRequest request, HttpServletResponse response) throws Exception {
